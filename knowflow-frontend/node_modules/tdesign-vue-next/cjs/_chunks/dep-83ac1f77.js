...
var dom = require('./dep-910c567c.js');
var index$1 = require('./dep-66b5d186.js');
require('@babel/runtime/helpers/toConsumableArray');
require('@babel/runtime/helpers/typeof');
var index$2 = require('./dep-90720be5.js');
var index = require('./dep-b1d94383.js');
require('./dep-baf36d63.js');
var isFunction = require('./dep-2d37d5cd.js');
...
var _Loading = Vue.defineComponent({
  ...
  setup: function setup(props2, _ref) {
    ...
    var _useConfig = configProvider_hooks_useConfig.useConfig("loading"),
    ...
    var inheritColor = Vue.computed(function () {
    ...
    var preventScrollThrough = Vue.computed(function () {
    ...
    var classes = Vue.computed(function () {
      var baseClasses = [centerClass.value, index$1.getPropertyValFromObj(SIZE.value, size.value), _defineProperty__default["default"]({}, inheritColorClass.value, inheritColor.value)];
      var fullScreenClasses = [name.value, fullscreenClass.value, centerClass.value, overlayClass.value];
      return {
        baseClasses: baseClasses,
        attachClasses: baseClasses.concat([name.value, fullClass.value, _defineProperty__default["default"]({}, overlayClass.value, showOverlay.value)]),
        withContentClasses: baseClasses.concat([name.value, fullClass.value, _defineProperty__default["default"]({}, overlayClass.value, showOverlay.value)]),
...
//# sourceMappingURL=dep-83ac1f77.js.map
