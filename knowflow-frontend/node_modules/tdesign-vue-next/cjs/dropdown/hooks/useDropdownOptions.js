...
var Vue = require('vue');
var index = require('../../_chunks/dep-bdaed78a.js');
...
var _getOptionsFromChildren = function getOptionsFromChildren(menuNode) {
  ...
  if (isArray.isArray(menuNode)) {
    ...
    return menuNode.map(function (item) {
      var _item$children, _item$children$conten, _item$children2, _item$children2$prefi, _item$children3, _item$children3$prefi, _item$children4, _item$children4$defau, _groupChildren$filter, _groupChildren$filter2, _item$dirs;
      ...
      return _objectSpread(_objectSpread(_objectSpread({
        ...
        directives: ((_item$dirs = item.dirs) === null || _item$dirs === void 0 ? void 0 : _item$dirs.map(function (d) {
