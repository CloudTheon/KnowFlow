...
var index$2 = require('../_chunks/dep-66b5d186.js');
var index$1 = require('../_chunks/dep-90720be5.js');
...
var list_constants_index = require('./constants/index.js');
  ...
  setup: function setup(props2, _ref) {
    ...
    var renderLoading = function renderLoading() {
      if (props2.asyncLoading && isString.isString(props2.asyncLoading)) {
        if (props2.asyncLoading === list_constants_index.LOADING) {
        ...
        if (props2.asyncLoading === list_constants_index.LOAD_MORE) {
    ...
    var handleLoadMore = function handleLoadMore(e) {
      ...
      if (isString.isString(props2.asyncLoading) && props2.asyncLoading !== list_constants_index.LOAD_MORE) return;
