...
var index$3 = require('../_chunks/dep-bdaed78a.js');
...
var index$4 = require('../_chunks/dep-0eb89d70.js');
...
var _Swiper = Vue.defineComponent({
  ...
  setup: function setup(props2, _ref) {
    ...
    var swiperTo = function swiperTo(index, context) {
      ...
      var length = swiperItemLength.value;
      var targetIndex = (index % length + length) % length;
      ...
      if (props2.animation === "slide" && length > 1 && props2.type !== "card") {
        targetIndex = index;
        isBeginToEnd = false;
        isEndToBegin = false;
        if (index >= length) {
