...
var index = require('../_chunks/dep-66b5d186.js');
...
var table_hooks_useDragSort = require('../_chunks/dep-af4a0111.js');
...
var omit = require('../_chunks/dep-1f53c8f1.js');
var get = require('../_chunks/dep-6f400677.js');
...
require('../_chunks/dep-d529b3b2.js');
...
var _PrimaryTable = Vue.defineComponent({
  ...
  setup: function setup(props, context) {
    ...
    var _useDragSort = table_hooks_useDragSort.useDragSort(props, context, dragSortParams),
    ...
    var onEditableCellChange = function onEditableCellChange(params) {
      ...
      var sourceRowValue = get.get(params.row, rowKey);
      (_props$onRowEdit = props.onRowEdit) === null || _props$onRowEdit === void 0 || _props$onRowEdit.call(props, params);
      var sourceRow = props.data.find(function (row) {
        return get.get(row, rowKey) === sourceRowValue;
      });
      if (sourceRow && sourceRow !== params.row) {
        Object.assign(sourceRow, params.row);
      }
      var rowValue = get.get(params.editedRow, rowKey);
      ...
      var _loop = function _loop() {
        ...
        if ((_item$edit = item.edit) !== null && _item$edit !== void 0 && _item$edit.component) {
          ...
          item.cell = function (h2, p) {
            ...
            var errorListKey = [rowValue, p.col.colKey].join("__");
            var errorList = (_errorListMap$value = errorListMap.value) === null || _errorListMap$value === void 0 ? void 0 : _errorListMap$value[errorListKey];
