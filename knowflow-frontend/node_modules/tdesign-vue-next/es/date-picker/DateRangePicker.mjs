...
import { d as dayjs } from '../_chunks/dep-9f0aa3ce.mjs';
import { u as usePrefixClass, e as useDisabled, o as useReadonly } from '../_chunks/dep-84e0bbb7.mjs';
...
import { g as getDefaultFormat, f as formatDate, a as formatTime, i as initYearMonthTime, p as parseToDayjs, b as isValidDate } from '../_chunks/dep-c563673a.mjs';
import { g as getRangeBounds, s as subtractMonth, a as addMonth, e as extractTimeObj } from '../_chunks/dep-f0eac088.mjs';
...
import '../_chunks/dep-3f6d3801.mjs';
import '../_chunks/dep-9ee4025c.mjs';
...
import '../tag/tag.mjs';
import '../_chunks/dep-5f582443.mjs';
...
import '../_chunks/dep-c15311c9.mjs';
import '../time-picker/panel/time-picker-panel.mjs';
import '../_chunks/dep-d430f2b2.mjs';
import '../time-picker/props.mjs';
import '../_chunks/dep-b38ca281.mjs';
import '../_chunks/dep-cd4bc8e6.mjs';
  ...
  setup: function setup(props2, _ref) {
    ...
    function onCellClick(date, _ref2) {
      ...
      if (notValidIndex === -1 && normalizedValue.length === 2) {
        if (!isFirstValueSelected.value && normalizedValue[0] && normalizedValue[1] && parseToDayjs(normalizedValue[0], formatRef.value.format).isAfter(parseToDayjs(normalizedValue[1], formatRef.value.format))) {
          normalizedValue[activeIndex.value ? 0 : 1] = "";
          cacheValue.value = normalizedValue;
          inputValue.value = normalizedValue;
        } else {
          onRawChange === null || onRawChange === void 0 || onRawChange(formatDate(normalizedValue, {
            format: formatRef.value.format,
    ...
    var confirmValueChange = function confirmValueChange(e) {
      ...
      if (notValidIndex === -1 && nextValue.length === 2) {
        if (!isFirstValueSelected.value && nextValue[0] && nextValue[1] && parseToDayjs(nextValue[0], formatRef.value.format).isAfter(parseToDayjs(nextValue[1], formatRef.value.format))) {
