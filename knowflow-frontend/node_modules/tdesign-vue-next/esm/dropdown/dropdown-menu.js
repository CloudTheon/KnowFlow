...
import { defineComponent, reactive, ref, onMounted, createVNode, withDirectives, h } from 'vue';
    ...
    var _renderOptions = function renderOptions(data, deep) {
      ...
      (_data$forEach = data.forEach) === null || _data$forEach === void 0 || _data$forEach.call(data, function (menu, idx) {
        ...
        if (optionItem.children) {
          ...
          var item = createVNode(_DropdownItem, {
          ...
          renderContent = createVNode("div", {
            "key": idx
          }, [Array.isArray(optionItem.directives) && optionItem.directives.length ? withDirectives(item, optionItem.directives) : item, optionItem.divider ? createVNode(Divider, null, null) : null]);
        } else {
          var _item = createVNode(_DropdownItem, {
            "style": optionItem.style,
          ...
          renderContent = createVNode("div", {
            "key": idx
          }, [optionItem.directives ? withDirectives(_item, optionItem.directives) : _item, optionItem.divider ? createVNode(Divider, null, null) : null]);
        }
