...
import { l as log } from '../_chunks/dep-176718ac.js';
import { s as swapDragArrayElement } from '../_chunks/dep-2b9f9ddc.js';
...
var _EnhancedTable = defineComponent({
  ...
  setup: function setup(props, context) {
    ...
    var onDragSortChange = function onDragSortChange(params) {
      ...
      var dragSortParams = params;
      if (params.sort === "col") {
        var currentIndex = params.currentIndex,
          targetIndex = params.targetIndex;
        var newData = swapDragArrayElement(_toConsumableArray(props.columns), currentIndex, targetIndex);
        dragSortParams = _objectSpread(_objectSpread({}, params), {}, {
          data: props.columns,
      ...
      if (dragSortParams.sort === "col") {
        ...
        (_props$onDragSort = props.onDragSort) === null || _props$onDragSort === void 0 || _props$onDragSort.call(props, dragSortParams);
        return;
      }
      swapData({
      ...
      (_props$onDragSort2 = props.onDragSort) === null || _props$onDragSort2 === void 0 || _props$onDragSort2.call(props, dragSortParams);
    };
