...
import { u as useTNodeJSX, a as useContent, g as getTextFromVNode } from '../_chunks/dep-4cf1cec7.js';
  ...
  setup: function setup(props2) {
    ...
    var renderTitle = function renderTitle(tagContent) {
      ...
      if (Reflect.has(vProps, "title")) {
        if (vProps.title === false) return void 0;
        if (vProps.title === true) return tagContent || void 0;
        return vProps.title || void 0;
      }
      return tagContent || void 0;
    };
    return function () {
