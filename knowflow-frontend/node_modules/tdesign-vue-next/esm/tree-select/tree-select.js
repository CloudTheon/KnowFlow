...
import { u as useTNodeJSX, b as useTNodeDefault } from '../_chunks/dep-4cf1cec7.js';
import { u as usePrefixClass } from '../_chunks/dep-eff63d83.js';
import { u as useDefaultValue } from '../_chunks/dep-e99edabd.js';
...
import { u as useVModel } from '../_chunks/dep-a22671e7.js';
import { u as useEventForward } from '../_chunks/dep-683a5fb2.js';
...
var _TreeSelect = defineComponent({
  ...
  setup: function setup(props2, _ref) {
    ...
    var change = function change(valueParam, node, trigger, e, index) {
      var _node$data;
      setTreeSelectValue(valueParam, {
        node: node,
        trigger: trigger,
        data: (_node$data = node === null || node === void 0 ? void 0 : node.data) !== null && _node$data !== void 0 ? _node$data : null,
        index: index,
        e: e
      });
      changeNodeInfo();
    ...
    var treeNodeChange = function treeNodeChange(valueParam, context) {
      ...
      var trigger = context.node.checked ? "check" : "uncheck";
      var index = context.node.getIndex();
    ...
    var tagChange = function tagChange(value2, context) {
      ...
      change(treeSelectValue.value, null, trigger, context === null || context === void 0 ? void 0 : context.e, index);
    };
