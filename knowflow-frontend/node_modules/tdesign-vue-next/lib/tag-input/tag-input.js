...
import { defineComponent, toRefs, ref, reactive, computed, watch, getCurrentInstance, onMounted, createVNode, mergeProps, nextTick } from 'vue';
...
var _TagInput = defineComponent({
  ...
  setup: function setup(props2, _ref) {
    ...
    watch(function () {
      ...
      return [excessTagsDisplayType.value, suffix.value, showClearIcon.value, classPrefix.value, isBreakLine.value, size.value, (_tagValue$value3 = tagValue.value) === null || _tagValue$value3 === void 0 ? void 0 : _tagValue$value3.length];
    }, function () {
