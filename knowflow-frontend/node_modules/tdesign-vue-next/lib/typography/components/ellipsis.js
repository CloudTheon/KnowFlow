...
var Ellipsis = defineComponent({
  ...
  setup: function setup(props2, _ref) {
    ...
    var ellipsisState = computed(function () {
      var ellipsis = _typeof(props2.ellipsis) === "object" ? _objectSpread({}, props2.ellipsis) : {};
      return _objectSpread({
        row: 1,
        expandable: false
      }, _objectSpread(_objectSpread({}, ellipsis), {}, {
        placement: "top-right"
      }));
    });
    ...
    return function () {
      ...
      }, [tooltipProps && createVNode(Tooltip, tooltipProps, null), createVNode("p", {
